    ...
    <div className="bg-[#F1F1F1] -mt-40 dark:bg-gray-900">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8 lg:-mt-8 pb-40">
          ...
          {/* Single card */}
          <a
            href="https://calculadora-offgrid.com.br"
            className="w-full block col-span-1 sm:col-span-1 shadow-"
          >
            <div className="relative overflow-hidden">
              ...
              />
              <h1 className="absolute top-10 left-10 text-gray-50 font-bold text-xl bg-green-900 rounded-md px-2">
                Calculadora Offgrid
              </h1>
              <h1 className="absolute bottom-10 left-10 text-green-900 font-bold text-xl">
                02
              </h1>
            </div>
          </a>
